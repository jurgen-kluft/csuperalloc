...
namespace ncore
{
    ...
    struct superfsa_t
    {
        ...
        nsuperfsa::section_t* m_sections;
        ...
        nsuperfsa::block_t**  m_active_block_list_per_allocsize;   // blocks that still have available free items, a list per allocation size
    };
    ...
    namespace nsuperfsa
    {
        ...
        void  deallocate(superfsa_t* fsa, void* ptr);
    ...
    {
        return (T*)nsuperfsa::allocate(fsa, sizeof(T));
    }

    template <typename T>
    T* g_allocate_array(superfsa_t* fsa, u32 count)
    {
        return (T*)nsuperfsa::allocate(fsa, sizeof(T) * count);
    }

    template <typename T>
    void g_deallocate(superfsa_t* fsa, T* ptr)
    {
        nsuperfsa::deallocate(fsa, (void*)ptr);
    }
