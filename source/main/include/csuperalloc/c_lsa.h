...
namespace ncore
{
    ...
    namespace nlsa
    {
        ...
        lsa_t* new_lsa(u16 sizeof_block = 64 * 1024, u16 num_blocks = 1024);
        void   destroy(lsa_t* lsa);
        // minimum alloc size is one power-of-two level lower than the block size
        ...
        void* idx2ptr(lsa_t* lsa, u32 index);
    }  // namespace nlsa
