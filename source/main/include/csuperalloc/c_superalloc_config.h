...
namespace ncore
{
    namespace nsuperalloc
    {
        ...
        struct binconfig_t
        {
            binconfig_t(u32 alloc_size, chunkconfig_t const& chunk_config)
            ...
            const u32           m_alloc_size;       // The size of the allocation that this bin is managing
        ...
        struct config_t
        {
            ...
            virtual u8 size2bin(u32 size) const = 0;
