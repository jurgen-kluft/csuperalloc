...
#define SUPERALLOC_DEBUG
    ...
    namespace nsuperalloc_config_25p
    {
        ...
        static const binconfig_t c_abinconfigs[] = {
            ...
            {8,         8,  c64KB},                    {9,    16, c64KB},                        // 8, 16
            {10,        16, c64KB},                    {11,   16, c64KB},                        // 16, 16
            {12,        16, c64KB},                    {13,   24, c64KB},                        // 16, 24
            {14,        24, c64KB},                    {15,   32, c64KB},                        // 24, 28
        ...
        class config_t : public superalloc_config_t
        {
        public:
    ...
    superalloc_config_t const* gGetSuperAllocConfigWindowsDesktopApp25p()
    {
        ...
        nsuperalloc_config_25p::config_t* config = &nsuperalloc_config_25p::s_config;
    ...
    superalloc_config_t const* gGetSuperAllocConfigWindowsDesktopApp10p()
    {
        ...
        nsuperalloc_config_10p::config_t* config = &nsuperalloc_config_10p::s_config;
