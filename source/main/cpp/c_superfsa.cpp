...
namespace ncore
{
    namespace nsuperalloc
    {
        ...
        namespace nsuperfsa
        {
            ...
            {
            public:
                void         initialize(superheap_t* heap, u64 address_range, u32 section_size);
                void         deinitialize(superheap_t* heap);
            ...
            void alloc_t::initialize(superheap_t* heap, u64 address_range, u32 section_size)
            {
                m_heap                  = heap;
            ...
            void alloc_t::deinitialize(superheap_t* heap)
            {
                ...
                superheap_deallocate(heap, m_active_block_list_per_allocsize);
                superheap_deallocate(heap, m_active_section_bin0_per_blockcfg);
                superheap_deallocate(heap, m_active_section_bin1_per_blockcfg);
                superheap_deallocate(heap, m_sections_free_bin1);
                superheap_deallocate(heap, m_sections);
